...
class DzvideoTablevideo extends JTable {    
    ...
    public function check() {
        ...
        // Verify that the alias and videoid is unique
        ...
        if ($table->load(array('videoid' => $this->videoid)) && ($table->id != $this->id || $this->id == 0))
        {
            $this->setError(JText::_('COM_DZVIDEO_ERROR_DUPLICATE_VIDEO'));
            return false;
        }
