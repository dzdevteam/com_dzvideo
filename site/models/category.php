...
class DzvideoModelCategory extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
        ...
        $this->setState('list.ordering',$mergedParams->get('ordering'));
        $this->setState('list.direction',$mergedParams->get('direction'));
        
        $limit = $app->getUserStateFromRequest('global.list.limit', 'limit',$mergedParams->get('display_number'), $app->getCfg('list_limit'));
